...
Note em um problema de classificação unirrótulo todas as instâncias da forma $(x',y')$ tem como $y'$
...
Assim construir um classificador multirrótulo parece ser mais complexo que um classificador unirrótulo.
