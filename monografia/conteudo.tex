...
Na primeira camada (a esquerda), os classificadores binários do BR provê cada
...
Na primeira camada (a esquerda), os classificadores binários do BR provê estimativas de cada
...
\endpsmatrix
$
\caption{Basic idea of the recursive dependent binary relevance
...
%  $c_0(x)$ resulta na estimativa $\hat{y}^3=c_1(c_1(c_1(c_0(x))))$ e assim por diante.
 ...
 na figura \ref{fig:RDBRstochastic}.
