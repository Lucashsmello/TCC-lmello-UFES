...
% Nessa área, computadores são programados para aprender com as experiências
...
o rótulo ou os rótulos de uma instância forma correta.
...
uma instância é definida como sendo um vetor $(x,y)$ tal que $x\in X$ e $y$ é um vetor binário
$y=(y_1,y_2,...,y_r)$ de tal forma $y_i=1$ indica a presença do rótulo $l_i$ na instância.
...
a maximizar uma métrica de qualidade, definida pela função $f: Y \rightarrow [0,1]$  para 
