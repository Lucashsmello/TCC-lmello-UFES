...
/**
 * 
 <!-- globalinfo-start --> Class implementing the Ensemble of Classifier
 * Chains(ECC) algorithm. For more information, see<br/>
 * <br/>
 ...
 * @version 2012.02.27
 */
public class lmelloECC extends TransformationBasedMultiLabelLearner {
	 ...
	 *            the size of each bag sample, as a percentage of the training
	 *            size
	 */
	 ...
	 */
	public lmelloECC(Classifier classifier, int aNumOfModels,
	...
	protected void buildInternal(MultiLabelInstances trainingSet)
		...
		for (int i = 0; i < numOfModels; i++) {
			...
			MultiLabelInstances train = new MultiLabelInstances(sampledDataSet,
	...
	protected MultiLabelOutput makePredictionInternal(Instance instance)
		...
		return makePredictionInternal2(instance);
	}

	private MultiLabelOutput makePredictionInternal2(Instance instance)
			throws Exception, InvalidDataException {
